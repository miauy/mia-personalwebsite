          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="space-y-4 max-w-2xl">
              ...
              <div className="text-muted-foreground text-justify">
                <p>
                  I am a recent graduate of the University of Miami with a Bachelor of Arts in Computer Science and a Bachelor of Science in Communication (B.S.C.) in Immersive Media. I am seeking a career in Product Management in the technology industry, specifically within extended reality (XR). I discovered my passion for XR during my time as a project manager at my university's Virtual Experience Simulation Lab (VESL), where I have managed XR projects from proposal to deployment. In addition to managing projects, I have also explored UI/UX design and created the user interface for a VR community garden simulation that teaches kids in underprivileged communities how and where food is grown.
                </p>
                <p className="mt-4">
